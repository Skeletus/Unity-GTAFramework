...
namespace GTAFramework.GTA_Animation.Data
{
    ...
    public class CharacterAnimationConfig : ScriptableObject
    {
        ...
        [Header("Airborne")]
        [Tooltip("Ventana para permitir saltar justo despues de dejar el suelo (coyote time).")]
        [Min(0f)] public float coyoteTime = 0.12f;

        [Tooltip("Tiempo minimo en el aire para considerar que ya estas realmente airborne (evita false positives).")]
        ...
        [Tooltip("Umbral para considerar caida. Ej: -0.1 o -0.2 (mas negativo = mas estricto).")]
